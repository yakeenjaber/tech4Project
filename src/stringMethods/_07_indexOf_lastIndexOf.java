...
public class _07_indexOf_lastIndexOf {
    public static void main(String[] args) {
        ...
        String sentence = "Hello World is my first program.";

        System.out.println(sentence.indexOf('o')); // 7
        System.out.println(sentence.indexOf('H')); // 10
        System.out.println(sentence.lastIndexOf('o')); // 45
